    ...
    <section id="home">
      ...
      >
        ...
        <div className="md:mt-2 md:w-3/5 relative">
          ...
          >
            Hi, I'm Yuvansh Chauhan!
          </h1>
          <p className="font-semibold text-xl mt-4 mb-6 md:text-2xl">
            <span className="">B.Tech CSE Student @ IIIT Dharwad</span>
          </p>
          <p className="mt-4 mb-10 text-gray-300 md:text-lg">
            Python | C | C++ | Java | Express | MySQL | MongoDB
            <br />
            TypeScript | React | Redux | JavaScript | Tailwind | Git | Github
          </p>
          {/* <a
						target="_blank"
						href={cv}
